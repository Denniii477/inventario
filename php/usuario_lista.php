<?php
	...
	$Npaginas =ceil($total/$registros); //con este "ceil" redondeamos al numero siguiente proximo
	...
	if($total>=1 && $pagina<=$Npaginas){
		echo paginador_tablas($pagina,$Npaginas,$url,7); //el 7 para limitar cuantos botones tendra 
		//cada pagina
	}